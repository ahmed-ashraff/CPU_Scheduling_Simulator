//
// Created by Dev Ahmed on 12/6/2023.
//

#ifndef CPU_SCHEDULING_COMPAREFUNCTIONS_H
#define CPU_SCHEDULING_COMPAREFUNCTIONS_H
...
#endif //CPU_SCHEDULING_COMPAREFUNCTIONS_H
